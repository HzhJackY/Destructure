...
payload = {
    "sunshine_insurance": {
        "company_id": "SUNSHINE_INSURANCE",
        "company_name": "阳光保险",
        "legal_entity_name": "阳光保险集团股份有限公司",
        "stock_code": "06963.HK",
        "years": {
            "2023": {
                "filename": "阳光保险2023年度报告.pdf",
                "bs_page": 160, "bs_printed": 158,
                "unit_bs": "RMB_MILLION", "unit_mda": "RMB_MILLION",
                "bs_members": [
                    ...
                    {"member_id": "other_equity_investment", "raw_label": "以公允價值計量且其變動計入其他綜合收益的權益工具", "note": "24", "current_amount": 42946, "comp_amount": 36929},
            ...
            "2024": {
                ...
                "notes_pages": {
                    ...
                    "24": {"title": "以公允價值計量且其變動計入其他綜合收益的權益工具", "page": 248, "printed": 247}
                },
                "child_tables": [
                    {
            ...
            "2025": {
                ...
                "notes_pages": {
                    ...
                    "24": {"title": "以公允價值計量且其變動計入其他综合收益的权益工具", "page": 235, "printed": 234}
                },
                "child_tables": [
                    {
...
Path(r"C:\dev\AXA_research\scripts\all_5_companies_payload.json").write_text(json.dumps(payload, ensure_ascii=False, indent=2), encoding="utf-8")
print("Sunshine Insurance added to payload.")
