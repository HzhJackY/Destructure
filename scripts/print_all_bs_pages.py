...
BS_MAP = [
    ...
    # PICC P&C (中国财险)
    ("中国财险", "picc_pnc", 2023, "中国财险2023年度报告.pdf", 116),
    ("中国财险", "picc_pnc", 2024, "中国财险2024年度报告.pdf", 106),
    ("中国财险", "picc_pnc", 2025, "中国财险2025年度报告.pdf", 101),

    # China Re (中国再保)
    ("中国再保", "china_re", 2023, "中国再保2023年年度报告.pdf", 155),
    ("中国再保", "china_re", 2024, "中国再保2024年年度报告.pdf", 155),
    ("中国再保", "china_re", 2025, "中国再保2025年年度报告.pdf", 154),
    ...
    # AIA (友邦保险)
    ("友邦保险", "aia", 2023, "友邦保险2023年报.pdf", 160),
    ("友邦保险", "aia", 2024, "友邦保险2024年报.pdf", 168),
    ("友邦保险", "aia", 2025, "友邦保险2025年报.pdf", 156),
]

for comp_name, comp_id, year, filename, p_num in BS_MAP:
    doc = fitz.open(DOCU / filename)
    txt = doc[p_num - 1].get_text()
    print(f"\n======================================== {comp_name} ({comp_id}) {year} Page {p_num} ========================================")
    print(txt)
