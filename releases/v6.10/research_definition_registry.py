...
BUILTIN_MEMBERS = {
    "financial_investment": [
        ...
        {"member_id": "fvtpl_assets", "display_name": "以公允价值计量且其变动计入当期损益的金融资产", "member_role": "NOTE_DETAIL", "required": True, "canonical_order": 1, "aliases": ["交易性金融资产", "FVTPL金融资产"], "row_signatures": [], "presentation_regime": "NEW_FINANCIAL_INSTRUMENT_CLASSIFICATION", "canonical_analysis_bucket": "fvtpl_assets", "comparability_status": "EXACT"},
        {"member_id": "debt_investment", "display_name": "债权投资", "member_role": "NOTE_DETAIL", "required": True, "canonical_order": 2, "aliases": [], "row_signatures": ["政府债券", "金融债", "企业债"]},
        {"member_id": "other_debt_investment", "display_name": "其他债权投资", "member_role": "NOTE_DETAIL", "required": True, "canonical_order": 3, "aliases": [], "row_signatures": ["政府债券", "金融债"]},
        {"member_id": "other_equity_investment", "display_name": "其他权益工具投资", "member_role": "NOTE_DETAIL", "required": True, "canonical_order": 4, "aliases": [], "row_signatures": ["股票", "基金"]},
        ...
        {"member_id": "held_to_maturity_investments", "display_name": "持有至到期投资", "member_role": "NOTE_DETAIL", "required": False, "canonical_order": 14, "aliases": [], "row_signatures": [], "direct_member": True, "presentation_regime": "LEGACY_FINANCIAL_ASSET_CLASSIFICATION", "canonical_analysis_bucket": "held_to_maturity_investments", "comparability_status": "PARTIALLY_COMPARABLE"},
        {"member_id": "long_term_equity", "display_name": "长期股权投资", "member_role": "NOTE_DETAIL", "required": False, "canonical_order": 15, "aliases": [], "row_signatures": [], "direct_member": True, "presentation_regime": "LEGACY_FINANCIAL_ASSET_CLASSIFICATION", "canonical_analysis_bucket": "long_term_equity", "comparability_status": "PARTIALLY_COMPARABLE"},
    ],
    "investment_portfolio": [
    ...
    def seed_builtin(self) -> None:
        with self.registry.connect() as conn:
            ...
            for family_id, payload in BUILTIN_FAMILIES.items():
                ...
                # v6.10 adds a release-owned resolution contract.  It is a
                # semantic safety contract, not a user-authored alias list;
                # merge it into an existing seeded family without deleting
                # any user extension fields.
                if family_id == "financial_investment":
                    ...
                    # Add release-owned safety defaults without overwriting a
                    # user-approved restriction or extension.
                ...
                for member in BUILTIN_MEMBERS[family_id]:
                    ...
                    changed = False
                    for key in ("direct_member", "presentation_regime", "canonical_analysis_bucket", "comparability_status"):
                        if key in member and key not in current_member_payload:
