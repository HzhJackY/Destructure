...
class CaptureService:
    ...
    def _execute_resolved_target(
        ...
        certified_page_span=max(1, int(target.end_page) - int(target.start_page) + 1)
        ...
        return self._create_legacy(
            ...
            max_pages=configured_max_pages if direct_full_book else min(configured_max_pages,certified_page_span),
