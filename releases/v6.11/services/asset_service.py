...
class AssetService:
    ...
    def filter_options(self):
        options={k:self.capture_repo.distinct_values(k) for k in ['lifecycle_status','table_query','company','document_year','producer_version','batch_id','header_parser']}
        options["research_batch_id"]=self.capture_repo.distinct_research_batches()
        return options
