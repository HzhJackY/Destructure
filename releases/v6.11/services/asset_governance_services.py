...
class ReviewInboxService:
    ...
    def __init__(self, repository, review_service=None):
        self.repo = repository
...
class AssetQueryService:
    ...
    def facets(self, rows: list[dict[str, Any]] | None = None) -> dict[str, list[str]]:
        ...
        fields = ("company_id", "report_year", "statement_scope", "research_batch_id",
                  "table_family_id", "member_table_id", "quality_status",
                  "review_status", "asset_status")
