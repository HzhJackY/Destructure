...
def build_text_index(pdf_path: Path, cache_root: Path, *, text_provider=None, force_rebuild: bool = False) -> list[TextIndexRecord]:
    ...
    fast_records, _ = build_fast_index(
        pdf_path, Path(cache_root), **fast_index_profile_kwargs(), force_rebuild=force_rebuild
    )
