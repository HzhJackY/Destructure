...
def render_capture_inspection_panel(
    ...
    if tab=="概览":
        ...
        st.dataframe([{
            ...
            "table_block_id":row.get("table_block_id"),
            "block_order":row.get("block_order"),
            "classification_axis":row.get("classification_axis"),
            "block_role":row.get("block_role"),
            "block_terminal_type":row.get("block_terminal_type"),
