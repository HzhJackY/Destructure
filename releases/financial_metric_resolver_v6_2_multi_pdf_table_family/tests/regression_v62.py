...
for order,item,level,parent,value in spec:
    rows.append({"row_order":order,"normalized_item":item,"raw_item":item,"parent_section":parent,"row_type":"DETAIL","row_level":level,"value":value,"unit":"元","column_ordinal":0,"table_id":"INVEST","canonical_section":"","canonical_item":item,"company":"A","document_year":"2025","year":"2025","scope":"本集团","restated":False,"mapping_status":"UNMAPPED_PRESERVED","capture_run_id":"R1","page":1})
