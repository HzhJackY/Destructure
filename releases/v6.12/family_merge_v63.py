...
OBSERVATION_KEY = ["company", "report_year", "table_family", "member_table", "row_path", "data_year", "scope", "restated", "period_type", "unit"]
COLUMN_DIMENSIONS = ["data_year", "scope", "restated", "period_type", "unit"]
