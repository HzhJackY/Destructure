...
FINANCIAL_INVESTMENT_MEMBER_CONTRACT_VERSION = (
    "FINANCIAL_INVESTMENT_MEMBER_CONTRACT_V6"
)
...
FINANCIAL_INVESTMENT_STANDARDS_BRIDGE_RULES = [
    {
        ...
        "new_members": ["fvtpl_assets"],
        "legacy_members": ["legacy_fvtpl_assets"],
        "comparability_status": "PARTIALLY_COMPARABLE",
        "same_period_policy": "FAIL_CLOSED_NO_SUM",
    },
    {
        "bridge_rule_id": "FI_BRIDGE_AMORTIZED_COST_DEBT_V1",
        "analysis_bridge_group": "AMORTIZED_COST_DEBT",
        "new_members": ["debt_investment"],
        "legacy_members": ["held_to_maturity_investments", "legacy_loans"],
        "comparability_status": "DISAGGREGATION_REQUIRED",
        "same_period_policy": "FAIL_CLOSED_NO_SUM",
    },
    {
        "bridge_rule_id": "FI_BRIDGE_FVOCI_DEBT_V1",
        "analysis_bridge_group": "FVOCI_DEBT",
        "new_members": ["other_debt_investment"],
        "legacy_members": ["available_for_sale_assets"],
        "comparability_status": "DISAGGREGATION_REQUIRED",
        "same_period_policy": "FAIL_CLOSED_NO_SUM",
    },
    {
        "bridge_rule_id": "FI_BRIDGE_FVOCI_EQUITY_V1",
        "analysis_bridge_group": "FVOCI_EQUITY",
        "new_members": ["other_equity_investment"],
        "legacy_members": ["available_for_sale_assets"],
        "comparability_status": "DISAGGREGATION_REQUIRED",
        "same_period_policy": "FAIL_CLOSED_NO_SUM",
    },
]
FINANCIAL_INVESTMENT_MEMBER_BRIDGE_MEMBERSHIPS = {
    member_id: [
        {
            "bridge_rule_id": rule["bridge_rule_id"],
            "analysis_bridge_group": rule["analysis_bridge_group"],
            "comparability_status": rule["comparability_status"],
            "same_period_policy": rule["same_period_policy"],
            "source_side": (
                "NEW" if member_id in rule["new_members"] else "LEGACY"
            ),
        }
        for rule in FINANCIAL_INVESTMENT_STANDARDS_BRIDGE_RULES
        if member_id in {*rule["new_members"], *rule["legacy_members"]}
    ]
    for member_id in {
        member_id
        for rule in FINANCIAL_INVESTMENT_STANDARDS_BRIDGE_RULES
        for member_id in [*rule["new_members"], *rule["legacy_members"]]
    }
}
...
BUILTIN_FAMILIES = {
    "financial_investment": {
        ...
        "family_resolution_contract": {
            ...
            "explicit_parent_aliases": ["金融投资", "金融投資"],
            ...
            "mutually_exclusive_members": [],
            "period_scoped_member_identity": "SOURCE_ROW_ID__PERIOD_IDENTITY",
            "filing_level_member_mutual_exclusion": False,
            "standards_bridge_rules": FINANCIAL_INVESTMENT_STANDARDS_BRIDGE_RULES,
            "presentation_regime_rules": "REGISTRY_MEMBER_SET_AND_PERIOD_APPLICABILITY",
            "member_inclusion_policy": "VERSIONED_EXACT_ALIAS_ONLY",
            "family_total_contract": "SOURCE_TOTAL_OR_CERTIFIED_DERIVATION_ONLY",
            "comparability_contract": "DUAL_VIEW_EXPLICIT_STANDARDS_BRIDGE_V1",
        },
...
BUILTIN_MEMBERS = {
    "financial_investment": [
        {"member_id": "financial_investment_anchor", "display_name": "金融投资_主报表构成", "member_role": "STATEMENT_ANCHOR", "required": True, "canonical_order": 0, "aliases": ["金融投资", "金融投資"], "row_signatures": ["债权投资", "其他债权投资", "債權投資", "其他債權投資"]},
        {"member_id": "fvtpl_assets", "display_name": "以公允价值计量且其变动计入当期损益的金融资产", "member_role": "NOTE_DETAIL", "required": True, "canonical_order": 1, "aliases": ["交易性金融资产", "交易性金融資產", "FVTPL金融资产", "以公允價值計量且其變動計入當期損益的金融資產", "按公平值計入損益", "按公平值计入损益"], "row_signatures": [], "presentation_regime": "NEW_FINANCIAL_INSTRUMENT_CLASSIFICATION", "classification_axis": "ASSET_TYPE", "canonical_analysis_bucket": "fvtpl_assets", "comparability_status": "EXACT", "analysis_bridge_groups": FINANCIAL_INVESTMENT_MEMBER_BRIDGE_MEMBERSHIPS["fvtpl_assets"]},
        {"member_id": "debt_investment", "display_name": "债权投资", "member_role": "NOTE_DETAIL", "required": True, "canonical_order": 2, "aliases": ["以摊余成本计量的债务工具投资", "以攤餘成本計量的債務工具投資", "以摊余成本计量的金融资产", "以攤餘成本計量的金融資產", "債權投資", "按攤銷成本", "按摊销成本"], "row_signatures": ["政府债券", "金融债", "企业债"], "presentation_regime": "NEW_FINANCIAL_INSTRUMENT_CLASSIFICATION", "classification_axis": "ASSET_TYPE", "canonical_analysis_bucket": "debt_investment", "comparability_status": "EXACT", "analysis_bridge_groups": FINANCIAL_INVESTMENT_MEMBER_BRIDGE_MEMBERSHIPS["debt_investment"]},
        {"member_id": "other_debt_investment", "display_name": "其他债权投资", "member_role": "NOTE_DETAIL", "required": True, "canonical_order": 3, "aliases": ["以公允价值计量且其变动计入其他综合收益的债务工具投资", "以公允價值計量且其變動計入其他綜合收益的債務工具投資", "以公允价值计量且其变动计入其他全面收益的金融资产", "以公允價值計量且其變動計入其他全面收益的金融資產", "以公允价值计量且其变动计入其他综合收益的金融资产", "以公允價值計量且其變動計入其他綜合收益的金融資產", "其他債權投資", "按公平值計入其他全面收入", "按公平值计入其他全面收入", "按公平值計入其他綜合收益", "按公平值计入其他综合收益"], "row_signatures": ["政府债券", "金融债"], "presentation_regime": "NEW_FINANCIAL_INSTRUMENT_CLASSIFICATION", "classification_axis": "ASSET_TYPE", "canonical_analysis_bucket": "other_debt_investment", "comparability_status": "EXACT", "analysis_bridge_groups": FINANCIAL_INVESTMENT_MEMBER_BRIDGE_MEMBERSHIPS["other_debt_investment"]},
        {"member_id": "other_equity_investment", "display_name": "其他权益工具投资", "member_role": "NOTE_DETAIL", "required": True, "canonical_order": 4, "aliases": ["指定为以公允价值计量且其变动计入其他综合收益的权益工具投资", "指定為以公允價值計量且其變動計入其他綜合收益的權益工具投資", "指定为以公允价值计量且其变动计入其他全面收益的权益工具投资", "指定為以公允價值計量且其變動計入其他全面收益的權益工具投資", "其他權益工具投資"], "row_signatures": ["股票", "基金"], "presentation_regime": "NEW_FINANCIAL_INSTRUMENT_CLASSIFICATION", "classification_axis": "ASSET_TYPE", "canonical_analysis_bucket": "other_equity_investment", "comparability_status": "EXACT", "analysis_bridge_groups": FINANCIAL_INVESTMENT_MEMBER_BRIDGE_MEMBERSHIPS["other_equity_investment"]},
        ...
        {"member_id": "legacy_fvtpl_assets", "display_name": "以公允价值计量且其变动计入当期损益的金融资产", "member_role": "NOTE_DETAIL", "required": False, "canonical_order": 10, "aliases": [], "row_signatures": [], "direct_member": True, "presentation_regime": "LEGACY_FINANCIAL_ASSET_CLASSIFICATION", "canonical_analysis_bucket": "legacy_fvtpl_assets", "comparability_status": "PARTIALLY_COMPARABLE", "analysis_bridge_groups": FINANCIAL_INVESTMENT_MEMBER_BRIDGE_MEMBERSHIPS["legacy_fvtpl_assets"]},
        {"member_id": "legacy_loans", "display_name": "贷款", "member_role": "NOTE_DETAIL", "required": False, "canonical_order": 11, "aliases": ["贷款及应收款项", "分类为贷款及应收款的投资", "分类为贷款及应收款项的投资"], "row_signatures": [], "direct_member": True, "presentation_regime": "LEGACY_FINANCIAL_ASSET_CLASSIFICATION", "canonical_analysis_bucket": "legacy_loans", "comparability_status": "PARTIALLY_COMPARABLE", "analysis_bridge_groups": FINANCIAL_INVESTMENT_MEMBER_BRIDGE_MEMBERSHIPS["legacy_loans"]},
        ...
        {"member_id": "available_for_sale_assets", "display_name": "可供出售金融资产", "member_role": "NOTE_DETAIL", "required": False, "canonical_order": 13, "aliases": [], "row_signatures": [], "direct_member": True, "presentation_regime": "LEGACY_FINANCIAL_ASSET_CLASSIFICATION", "canonical_analysis_bucket": "available_for_sale_assets", "comparability_status": "PARTIALLY_COMPARABLE", "analysis_bridge_groups": FINANCIAL_INVESTMENT_MEMBER_BRIDGE_MEMBERSHIPS["available_for_sale_assets"]},
        {"member_id": "held_to_maturity_investments", "display_name": "持有至到期投资", "member_role": "NOTE_DETAIL", "required": False, "canonical_order": 14, "aliases": [], "row_signatures": [], "direct_member": True, "presentation_regime": "LEGACY_FINANCIAL_ASSET_CLASSIFICATION", "classification_axis": "ASSET_TYPE", "canonical_analysis_bucket": "held_to_maturity_investments", "comparability_status": "PARTIALLY_COMPARABLE", "analysis_bridge_groups": FINANCIAL_INVESTMENT_MEMBER_BRIDGE_MEMBERSHIPS["held_to_maturity_investments"]},
        ...
        with self.registry.connect() as conn:
            ...
            for family_id, payload in BUILTIN_FAMILIES.items():
                ...
                if family_id == "financial_investment":
                    ...
                    for key, value in payload["family_resolution_contract"].items():
                        if key in {
                            ...
                            "comparability_contract", "period_scoped_member_identity",
                            "filing_level_member_mutual_exclusion", "standards_bridge_rules",
                        }:
                    ...
                    existing_contract["explicit_parent_aliases"] = list(
                        dict.fromkeys([
                            *(existing_contract.get("explicit_parent_aliases") or []),
                            "金融投资", "金融投資",
                        ])
                    )
                ...
                for member in BUILTIN_MEMBERS[family_id]:
                    ...
                    changed = False
                    for key in ("aliases", "row_signatures", "direct_member", "outside_family", "presentation_regime", "classification_axis", "canonical_analysis_bucket", "comparability_status", "analysis_bridge_groups", "activation"):
            ...
            for family_id, family in BUILTIN_FAMILIES.items():
                ...
                if family_id == "financial_investment":
                    ...
                    research_scope["standards_bridge_contract"] = {
                        "delivery_policy": "DUAL_VIEW_SOURCE_PRESENTATION_AND_EXPLICIT_BRIDGE",
                        "rules": [dict(rule) for rule in FINANCIAL_INVESTMENT_STANDARDS_BRIDGE_RULES],
                    }
