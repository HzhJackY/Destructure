...
_BS_STRONG_SIGNALS = [
    ...
    "负债及股东权益合计", "负债和权益总计",
    "資產總計", "資產總額", "負債合計", "負債總額",
    "負債和所有者權益總計", "負債及股東權益合計", "負債和權益總計",
    "權益總額", "股東權益總額", "资产总额", "负债总额",
    "Total assets", "Total liabilities",
]
_BS_AUX_SIGNALS = [
    "货币资金", "貨幣資金", "交易性金融资产", "交易性金融資產", "长期股权投资", "長期股權投資",
    "应付债券", "應付債券", "实收资本", "實收資本", "未分配利润", "未分配利潤",
    "定期存款", "应收利息", "應收利息", "固定资产", "固定資產",
    "金融投资", "金融投資", "投資物業", "投资物业",
    "以公允价值计量且其变动计入当期损益的金融资产", "以公允價值計量且其變動計入當期損益的金融資產",
    "以摊余成本计量的金融资产", "以攤餘成本計量的金融資產",
    "以公允价值计量且其变动计入其他综合收益的金融资产", "以公允價值計量且其變動計入其他全面收益的金融資產",
]
_BS_CONSOLIDATED_TOKENS = ["合并", "合併", "本集团", "本集團", "集团", "集團", "Consolidated", "Group"]
_BS_PARENT_TOKENS = ["母公司", "本公司资产负债表", "本公司資產負債表", "本公司財務狀況表", "本公司"]
