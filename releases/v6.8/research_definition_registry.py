...
BUILTIN_FAMILIES = {
    "financial_investment": {
        ...
        "optional_members": ["time_deposits", "reverse_repo", "long_term_equity", "capital_guarantee_deposit"], "excluded_members": [],
...
BUILTIN_MEMBERS = {
    "financial_investment": [
        ...
        {"member_id": "fvtpl_assets", "display_name": "以公允价值计量且其变动计入当期损益的金融资产", "member_role": "NOTE_DETAIL", "required": True, "canonical_order": 1, "aliases": ["交易性金融资产", "FVTPL金融资产"], "row_signatures": []},
    ...
    "investment_portfolio": [
        {"member_id": "portfolio_by_category", "display_name": "投资组合（按投资品种）", "member_role": "DIRECT_DISCLOSURE_TABLE", "required": True, "canonical_order": 1,
         "aliases": ["投资组合(按投资品种)", "投资组合按投资品种", "投资资产按投资品种", "投资资产配置（按品种）", "保险资金投资组合（按投资品种）"],
