...
def test_explicit_parent_requires_header_and_two_distinct_core_children():
    ...
    assert evidence["parent_recovery_status"] == "SOURCE_PARENT_RECOVERED"
