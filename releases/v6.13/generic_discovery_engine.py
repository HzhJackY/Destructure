...
from statement_note_navigation import build_text_index, fast_index_to_text_index, locate_primary_statements
...
from investment_portfolio_resolver import InvestmentPortfolioTopologyResolver
...
class GenericDiscoveryService:
    ...
    def _direct_portfolio_tables(
        ...
        # OCR remains a later candidate-page fallback; this resolver does not
        # create another whole-document OCR pipeline.
        index = build_text_index(pdf_path, self.cache_root, ocr_mode="off")
        return self.portfolio_resolver.resolve(
            pdf_path=pdf_path,
            index=index,
            members=members,
            company=company,
