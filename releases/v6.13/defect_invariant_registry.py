...
def _validate_multiblock_contract(kind: str) -> dict[str, Any]:
    test_path = Path(__file__).resolve().parent / "public_multiblock_invariant_probes.py"
    ...
    probes = {
        "multiblock_first_total": [
            "assert_first_total_does_not_end_table",
        ],
        "multiblock_axis_state": [
            "assert_ordered_classification_axes",
        ],
        "multiblock_field_propagation": [
            "assert_block_fields_survive_capture_long",
            "assert_block_fields_survive_canonical_materialization",
        ],
    }
    executed: list[str] = []
