...
def materialize_canonical(
    ...
    for column, default in {
        "table_family": "", "member_table": "", "member_table_role": "",
        "row_path": "", "period_type": "", "currency_unit": "", "unit": "",
...
def create_merge_project(
    ...
    manifest = {
        "version": "v6.6",
        "merge_schema_version": "6.6_SOURCE_AWARE_MEMBER_IDENTITY",
        "canonical_observation_schema_version": "6.6_EXPLICIT_OBSERVATION_DIMENSIONS",
        "table_id": table_id,
...
def refresh_merge_project(
    ...
    manifest["canonical_observation_schema_version"] = "6.6_EXPLICIT_OBSERVATION_DIMENSIONS"
