...
def build_backend_services(paths: dict[str, Path]) -> BackendServices:
    ...
    # Idempotent additive migration: existing v6.7 physical Captures are
    # projected into logical/version governance without changing evidence.
    logical_assets.bootstrap_existing()
    ...
    return BackendServices(
        ...
        orchestrator,capture_versions,review_tasks,
    )
