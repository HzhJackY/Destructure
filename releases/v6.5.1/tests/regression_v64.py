...
def main() -> None:
    # v6.5 keeps the v6.4 behavioural contract while advancing the release
    # identity and additive registry schema.
    assert APP_VERSION == "v6.5.1" and REGISTRY_SCHEMA_VERSION == 6
