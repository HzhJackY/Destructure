# Financial Metric Resolver v6.5.1
...
代码发布在 `releases/v6.5`；`releases/v6.4` 是冻结快照。两版共用 DATA_HOME，v6.5 迁移仅追加 SQLite 结构。详细设计见 [docs/architecture_v6_5.md](docs/architecture_v6_5.md) 与 [docs/release_policy.md](docs/release_policy.md)。
